...
import com.kreitek.learnjhipster.repository.StyleRepository;
import com.kreitek.learnjhipster.service.dto.StyleDTO;
import com.kreitek.learnjhipster.service.mapper.StyleMapper;
...
class StyleResourceIT {
    ...
    @Test
    @Transactional
    void putNewStyle() throws Exception {
        // Initialize the database
        styleRepository.saveAndFlush(style);
