...
/**
 * REST controller for managing {@link com.kreitek.learnjhipster.domain.Artist}.
 */
@RestController
@RequestMapping("/api")
public class ArtistResource {
    ...
    public ResponseEntity<Long> countArtists(ArtistCriteria criteria) {
        log.debug("REST request to count Artists by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
