...
import com.kreitek.learnjhipster.service.AlbumQueryService;
...
/**
 * REST controller for managing {@link com.kreitek.learnjhipster.domain.Album}.
 */
@RestController
@RequestMapping("/api")
public class AlbumResource {
    ...
    public ResponseEntity<Long> countAlbums(AlbumCriteria criteria) {
        log.debug("REST request to count Albums by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
