...
import com.kreitek.learnjhipster.service.SongQueryService;
import com.kreitek.learnjhipster.service.SongService;
...
/**
 * REST controller for managing {@link com.kreitek.learnjhipster.domain.Song}.
 */
@RestController
@RequestMapping("/api")
public class SongResource {
    ...
    public ResponseEntity<List<SongDTO>> getAllSongs(
        ...
        log.debug("REST request to get Songs by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
    ...
    public ResponseEntity<Long> countSongs(SongCriteria criteria) {
        log.debug("REST request to count Songs by criteria: {}", criteria.toString().replaceAll("[\n\r\t]", "_"));
